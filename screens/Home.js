...
export default class HomeScreen extends Component {
  ...
  getMovie = () => {
   // Write the code to get the movie details from the API
  ...
  likedMovie = () => {
   // Write the code to send the liked movie to the API
  ...
  unlikedMovie = () => {
   // Write the code to send the not liked movie to the API
   const url = "http://localhost:5000/notliked-movie";
   axios.post(url).then(response => {
     this.getMovie();
   }).catch(error => {
     console.log("Error")
  ...
  notWatched = () => {
   // Write the code to send the not watched movie to the API
